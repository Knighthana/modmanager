...
export const STR = {
  ...
  operationsPage: {
    ...
    progressStep: '步骤',
    progressMessage: '消息',
    applyDiagnosticsTitle: '🧭 应用诊断',
    clearDiagnostics: '清除诊断',
    diagTotalDirs: '备份目录总数',
    diagProcessedDirs: '已处理目录数',
    diagGateFailedDirs: 'Gate 失败目录',
    diagNoMatchedDirs: '无匹配目录',
    diagHintPrefix: '本次应用存在未生效分支：',
    diagGateFailedListTitle: 'Gate 失败目录明细',
    diagNoMatchedListTitle: '无匹配目录明细',
    diagDirPathLabel: '目录路径',
    diagActions: '操作',
    copyPath: '复制路径',
    copyPathSuccess: '路径已复制',
    copyPathFailed: '复制失败',
    copyPathUnsupported: '当前环境不支持剪贴板复制',
